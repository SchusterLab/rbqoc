"""
spin_exp3.py - Spin experiment 3.
"""
...
# CONTROLS_PATH = os.path.join(WDIR, "out/spin/spin_exp3/00002_spin_exp3.h5")
...
TARGET_STATE_0 = anp.array(((1,),
                            (0,)))
TARGET_STATE_1 = anp.array(((0,),
                            (r2_by_2 + 1j * r2_by_2,)))
