"""
spin_exp2_ampsweep.py - Do a sweep of the control amplitude multiplier
for spin_exp2.
"""
...
from spin_exp2 import (EVOL_CONFIG, EXPERIMENT_NAME, EXPERIMENT_META)
...
PULSE_FILE_0 = "00000_spin_exp2.h5"
PULSE_FILE_1 = "00007_spin_exp2.h5"
PULSE_FILES = (
    PULSE_FILE_0,
    PULSE_FILE_1,
)
