"""
spin_exp1_ampsweep.py - Do a sweep of the control amplitude multiplier
for spin_exp1.
"""
...
from spin_exp1 import (EVOL_CONFIG, EXPERIMENT_NAME, EXPERIMENT_META)
...
PULSE_FILE_1 = "00007_spin_exp1.h5"
PULSE_FILES = (
    PULSE_FILE_0,
    PULSE_FILE_1,
)
