...
state, and $u$ as the augmented controls. In practice the final state
of the quantum system matching the target state
is the most important metric, which is reflected in the weight
bias $Q_{N} \sim N \cdot Q_{1}$ and $Q_{k} = Q_{1}$.
...
feedback law--known as the Ricatti recursion. The
