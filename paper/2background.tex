...
\todo{Ask Brian to review paragraph. Are there other advantages to using ALTRO
  for quantum control that you would like to list in this paragraph? These are the reasons
  why we think it is better than what we were using previously.}
