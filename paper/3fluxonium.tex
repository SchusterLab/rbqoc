...
\myrem{The optimization problem takes the form:
\begin{mini!}[2] 
...
\myrem{We impose constraints that
...
\myadd{First, we outline the constraints for the fluxonium gate problem.
...
\myadd{Next, we outline the cost functions for the fluxonium gate problem.
