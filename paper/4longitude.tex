...
\todo{again, I'd recommend writing out either the entire optimization problem or at least
point to the parts of the optimization problem defined in the previous section you had to 
change. Just make it a little more concrete.}
...
The low gate errors achieved by the numerical gates \todo{typo / awkward sentence} 
