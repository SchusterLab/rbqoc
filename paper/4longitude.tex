...
\todo{Ask Brian to review this paragraph and next. Is the
optimization setup clear?}
...
constraint on the time step at each knot point. \todo{(Brian) the setup seems clear to me.} 
