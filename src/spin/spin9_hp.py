"""
spin9_hp.py - Do a sweep of the hamiltonian parameters
for spin9.
"""
...
PULSE_FILE_0 = "00001_spin9.h5"
PULSE_FILE_1 = "00006_spin_exp0.h5"
...
PULSE_PATH_4 = os.path.join(SAVE_PATH, PULSE_FILE_4)
PULSE_PATHS = [
    PULSE_PATH_0,
    PULSE_PATH_1,
    PULSE_PATH_2,
