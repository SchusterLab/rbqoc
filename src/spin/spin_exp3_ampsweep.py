"""
spin_exp3_ampsweep.py - Do a sweep of the control amplitude multiplier
for spin_exp3.
"""
...
from spin_exp3 import (EVOL_CONFIG, EXPERIMENT_NAME, EXPERIMENT_META)
...
PULSE_FILE_1 = "00003_spin_exp3.h5"
PULSE_FILES = (
    PULSE_FILE_0,
    PULSE_FILE_1,
)
