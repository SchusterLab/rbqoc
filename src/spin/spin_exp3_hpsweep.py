"""
spin_exp3_hpsweep.py - Do a sweep of the hamiltonian parameters
for spin_exp3.
"""
...
from spin_exp3 import (EVOL_ARGS, EXPERIMENT_META, EXPERIMENT_NAME, HAMILTONIAN_ARGS)
...
PULSE_FILE_0 = "00000_spin_exp3.h5"
PULSE_FILE_1 = "00001_spin_exp3.h5"
PULSE_FILES = [PULSE_FILE_0, PULSE_FILE_1]
PULSE_PATH_0 = os.path.join(SAVE_PATH, PULSE_FILE_0)
PULSE_PATH_1 = os.path.join(SAVE_PATH, PULSE_FILE_1)
PULSE_PATHS = [PULSE_PATH_0, PULSE_PATH_1]
