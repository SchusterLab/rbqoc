"""
spin19.jl - derivative robustness for a simple detuning problem, spin11.jl
...
const DSTATE1_IDX = CONTROLS_IDX[end] + 1:CONTROLS_IDX[end] + STATE_SIZE_ISO
...
function run_traj(;gate_type=xpi, evolution_time=10., solver_type=alilqr,
    ...
    Q = Diagonal(SVector{n}([
        ...
        fill(qs[2], 1); # control
        fill(qs[3], eval(:($derivative_order >= 1 ? $STATE_COUNT * $STATE_SIZE_ISO : 0))); # dstate<1,2>
