"""
spin_exp2.py - Spin experiment 2.
"""
...
# CONTROLS_PATH = os.path.join(WDIR, "out/spin/spin_exp2/00006_spin_exp2.h5")
...
TARGET_STATE_0 = anp.array(((r2_by_2,),
                            (r2_by_2,)))
TARGET_STATE_1 = anp.array(((-r2_by_2,),
                            (r2_by_2,)))
