"""
spin_example.py - Example QOC for the fluxonium.
"""
...
EXPERIMENT_NAME = "spin_example"
WDIR_PATH = os.environ.get("ROBUST_QOC_PATH", ".")
...
GRAB_CONTROLS = False
if GRAB_CONTROLS:
    CONTROLS_PATH = os.path.join(SAVE_PATH, "00000_spin_example.h5")
